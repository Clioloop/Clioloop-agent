...
const DEFAULT_SRC = new URL('../../assets/filler-bg0.webp', import.meta.url).href
 ...
 *   marks and a tiny "Clio Agent" mark in the corner — mirrors the
 *   overlay on the Clio Agent website.
...
export interface PosterProps {
  ...
  /**
   * Signature mark. In `vibe` this is the small "Clio Agent" overlay in the
   * bottom-right. In `dispatch` this is the URL / CTA in the footer.
   */
  signature?: React.ReactNode
  /** Override the poster image. Defaults to the Clio "filler-bg0" asset. */
  src?: string
