...
const FILLER_BG_SRC = new URL('../../../assets/filler-bg0.webp', import.meta.url).href;
export function Lens({ dark, initial }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: LAYER, style: {
                    ...
                    zIndex: 2
                }, children: _jsx("img", { alt: "", className: "h-[150dvh] w-auto min-w-dvw object-cover object-top-left invert", fetchPriority: "low", height: 1024, src: FILLER_BG_SRC, width: 1024 }) }), _jsx("div", { className: LAYER, style: {
