...
export function Card({ className, style, ...props }) {
    return (_jsx("div", { className: cn('border border-midground/15 bg-background-base/80 text-midground w-full', className), style: { ...CARD_STYLE, ...style }, ...props }));
}
export function CardHeader({ className, ...props }) {
    return (_jsx("div", { className: cn('flex flex-col gap-1.5 p-4 border-b border-midground/15', className), ...props }));
}
export function CardTitle({ className, ...props }) {
    return (_jsx("h3", { className: cn('font-expanded text-sm font-bold tracking-[0.08em] uppercase', className), ...props }));
}
export function CardDescription({ className, ...props }) {
    return (_jsx("p", { className: cn('font-mondwest text-xs text-midground/60', className), ...props }));
}
