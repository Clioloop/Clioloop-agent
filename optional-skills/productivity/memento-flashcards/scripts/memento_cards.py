...
Data file: $CLIO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CLIO_HOME = Path(os.environ.get("CLIO_HOME", Path.home() / ".clio"))
DATA_DIR = _CLIO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
