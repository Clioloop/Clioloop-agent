#!/usr/bin/env python3
"""
SWE Runner with Clio Trajectory Format

A runner that uses Clio-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Clio-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Clio-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Clio format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Clio-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Clio-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Clio Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Clio-Agent's built-in execution environments
    and outputs trajectories in Clio-Agent format.
    """
    ...
    def _convert_to_clio_format(
        ...
        """
        Convert internal message format to Clio trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Clio trajectory format
        trajectory = self._convert_to_clio_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Clio trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Clio Trajectory Format")
    print("=" * 60)
