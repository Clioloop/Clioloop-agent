...
import { launchClioDesktop } from '../store'
 ...
 * Clio.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchClioDesktop()}` which swallowed
