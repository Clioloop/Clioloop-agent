...
cd apps/desktop
XCURSOR_SIZE=24 CLIO_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/clio-typing
# → /tmp/clio-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/clio-typing.before.heapsnapshot
# → /tmp/clio-typing.after.heapsnapshot
```
