import { JsonRpcGatewayClient } from '@clio/shared'
...
export class ClioGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Clio gateway connection closed',
      connectErrorMessage: 'Could not connect to Clio gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Clio gateway is not connected',
...
// the call; each pooled backend already has its own CLIO_HOME, so no backend
...
export async function listSessions(
  ...
  const result = await window.clioDesktop.api<PaginatedSessions>({
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return window.clioDesktop.api<SessionSearchResponse>({
...
export function getSessionMessages(id: string, profile?: string | null): Promise<SessionMessagesResponse> {
  ...
  return window.clioDesktop.api<SessionMessagesResponse>({
...
export function renameSession(
  ...
  return window.clioDesktop.api<{ ok: boolean; title: string }>({
    ...(profile ? { profile } : {}),
    path: `/api/sessions/${encodeURIComponent(id)}`,
    method: 'PATCH',
...
export function getGlobalModelInfo(): Promise<ModelInfoResponse> {
  return window.clioDesktop.api<ModelInfoResponse>({
    ...profileScoped(),
    path: '/api/model/info'
  })
}
...
export function getStatus(): Promise<StatusResponse> {
  return window.clioDesktop.api<StatusResponse>({
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return window.clioDesktop.api<LogsResponse>({
    ...profileScoped(),
    path: suffix ? `/api/logs?${suffix}` : '/api/logs'
  })
}

export function getClioConfig(): Promise<ClioConfig> {
  return window.clioDesktop.api<ClioConfig>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getClioConfigRecord(): Promise<ClioConfigRecord> {
  return window.clioDesktop.api<ClioConfigRecord>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getClioConfigDefaults(): Promise<ClioConfigRecord> {
  return window.clioDesktop.api<ClioConfigRecord>({
    ...profileScoped(),
...
export function getClioConfigSchema(): Promise<ConfigSchemaResponse> {
  return window.clioDesktop.api<ConfigSchemaResponse>({
    ...profileScoped(),
    path: '/api/config/schema'
  })
}

export function saveClioConfig(config: ClioConfigRecord): Promise<{ ok: boolean }> {
  return window.clioDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: '/api/config',
    method: 'PUT',
...
export function getEnvVars(): Promise<Record<string, EnvVarInfo>> {
  return window.clioDesktop.api<Record<string, EnvVarInfo>>({
    ...profileScoped(),
    path: '/api/env'
  })
}
...
export function validateProviderCredential(
  ...
  return window.clioDesktop.api<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function revealEnvVar(key: string): Promise<{ key: string; value: string }> {
  return window.clioDesktop.api<{ key: string; value: string }>({
    ...profileScoped(),
    path: '/api/env/reveal',
    method: 'POST',
    body: { key }
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return window.clioDesktop.api<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function startOAuthLogin(providerId: string): Promise<OAuthStartResponse> {
  return window.clioDesktop.api<OAuthStartResponse>({
    ...profileScoped(),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return window.clioDesktop.api<OAuthSubmitResponse>({
    ...profileScoped(),
...
export function pollOAuthSession(providerId: string, sessionId: string): Promise<OAuthPollResponse> {
  return window.clioDesktop.api<OAuthPollResponse>({
    ...profileScoped(),
...
export function getSkills(): Promise<SkillInfo[]> {
  return window.clioDesktop.api<SkillInfo[]>({
    ...profileScoped(),
    path: '/api/skills'
  })
}
...
export function toggleSkill(name: string, enabled: boolean): Promise<{ ok: boolean; name: string; enabled: boolean }> {
  return window.clioDesktop.api<{ ok: boolean; name: string; enabled: boolean }>({
    ...profileScoped(),
...
export function getToolsets(): Promise<ToolsetInfo[]> {
  return window.clioDesktop.api<ToolsetInfo[]>({
    ...profileScoped(),
...
export function getToolsetConfig(name: string): Promise<ToolsetConfig> {
  return window.clioDesktop.api<ToolsetConfig>({
    ...profileScoped(),
...
export function selectToolsetProvider(
  ...
  return window.clioDesktop.api<{ ok: boolean; name: string; provider: string }>({
    ...profileScoped(),
...
export function getMessagingPlatforms(): Promise<MessagingPlatformsResponse> {
  return window.clioDesktop.api<MessagingPlatformsResponse>({
...
export function testMessagingPlatform(platformId: string): Promise<MessagingPlatformTestResponse> {
  return window.clioDesktop.api<MessagingPlatformTestResponse>({
...
export function getCronJobs(): Promise<CronJob[]> {
  return window.clioDesktop.api<CronJob[]>({
    path: '/api/cron/jobs'
  })
}
...
export function getProfiles(): Promise<ProfilesResponse> {
  return window.clioDesktop.api<ProfilesResponse>({
    path: '/api/profiles'
  })
}

export function createProfile(body: ProfileCreatePayload): Promise<{ name: string; ok: boolean; path: string }> {
  return window.clioDesktop.api<{ name: string; ok: boolean; path: string }>({
    path: '/api/profiles',
    method: 'POST',
    body
  })
...
export function deleteProfile(name: string): Promise<{ ok: boolean; path: string }> {
  return window.clioDesktop.api<{ ok: boolean; path: string }>({
    path: `/api/profiles/${encodeURIComponent(name)}`,
    method: 'DELETE'
  })
}
...
export function getProfileSoul(name: string): Promise<ProfileSoul> {
  return window.clioDesktop.api<ProfileSoul>({
...
export function getProfileSetupCommand(name: string): Promise<ProfileSetupCommand> {
  return window.clioDesktop.api<ProfileSetupCommand>({
    path: `/api/profiles/${encodeURIComponent(name)}/setup-command`
  })
}

export function getUsageAnalytics(days = 30): Promise<AnalyticsResponse> {
  return window.clioDesktop.api<AnalyticsResponse>({
    ...profileScoped(),
...
export function getGlobalModelOptions(): Promise<ModelOptionsResponse> {
  return window.clioDesktop.api<ModelOptionsResponse>({
    ...profileScoped(),
    path: '/api/model/options'
  })
}

// ── Omni Loop Portal (managed provider) ─────────────────────────────────
...
export interface PortalConnectStartResponse {
  status: string
  user_code: string
...
export interface PortalConnectStatusResponse {
...
export function getPortalStatus(): Promise<PortalStatusResponse> {
  return window.clioDesktop.api<PortalStatusResponse>({
    ...profileScoped(),
    path: '/api/portal'
  })
}

export function startPortalConnect(): Promise<PortalConnectStartResponse> {
  return window.clioDesktop.api<PortalConnectStartResponse>({
    ...profileScoped(),
    method: 'POST',
    path: '/api/portal/connect/start'
  })
}

export function getPortalConnectStatus(): Promise<PortalConnectStatusResponse> {
  return window.clioDesktop.api<PortalConnectStatusResponse>({
    ...profileScoped(),
    path: '/api/portal/connect/status'
  })
}
...
export interface RecommendedDefaultModel {
  provider: string
  model: string
  /** True/false for the managed provider (free vs paid tier); null for other providers. */
  free_tier: boolean | null
}

// Recommended default model for a freshly-authenticated provider. Mirrors the
// curation `clio model` does — for the managed provider it honors the free/paid tier so a
// free user gets a free model instead of a paid default.
export function getRecommendedDefaultModel(provider: string): Promise<RecommendedDefaultModel> {
  return window.clioDesktop.api<RecommendedDefaultModel>({
    ...profileScoped(),
...
export function setGlobalModel(
  ...
  return window.clioDesktop.api<{ ok: boolean; provider: string; model: string }>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body: {
...
export function getAuxiliaryModels(): Promise<AuxiliaryModelsResponse> {
  return window.clioDesktop.api<AuxiliaryModelsResponse>({
    ...profileScoped(),
...
export function setModelAssignment(body: ModelAssignmentRequest): Promise<ModelAssignmentResponse> {
  return window.clioDesktop.api<ModelAssignmentResponse>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body
...
export function restartGateway(): Promise<ActionResponse> {
  return window.clioDesktop.api<ActionResponse>({
    path: '/api/gateway/restart',
    method: 'POST'
  })
}

export function updateClio(): Promise<ActionResponse> {
  return window.clioDesktop.api<ActionResponse>({
    path: '/api/clio/update',
    method: 'POST'
  })
}

export function getActionStatus(name: string, lines = 200): Promise<ActionStatusResponse> {
  return window.clioDesktop.api<ActionStatusResponse>({
    path: `/api/actions/${encodeURIComponent(name)}/status?lines=${Math.max(1, lines)}`
  })
}

export function transcribeAudio(dataUrl: string, mimeType?: string): Promise<AudioTranscriptionResponse> {
  return window.clioDesktop.api<AudioTranscriptionResponse>({
...
export function speakText(text: string): Promise<AudioSpeakResponse> {
  return window.clioDesktop.api<AudioSpeakResponse>({
...
export function getElevenLabsVoices(): Promise<ElevenLabsVoicesResponse> {
  return window.clioDesktop.api<ElevenLabsVoicesResponse>({
