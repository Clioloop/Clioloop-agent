...
const SPECIAL_TOOL_NAMES = new Set(['todo', 'image_generate', 'music_generate', 'clarify'])
        ...
        <div className="grid w-full min-w-0 max-w-full gap-1.5 overflow-hidden p-1.5">
          ...
          {view.imageUrl && (
            <div className="max-w-72 overflow-hidden rounded-[0.25rem] border border-(--ui-stroke-tertiary)">
              <ResolvedImage alt="Tool output" className="h-auto w-full object-cover" src={view.imageUrl} />
            </div>
          )}
