...
function SudoDialog() {
  ...
  const send = useCallback(
    async (value: string) => {
      ...
      if (!gateway) {
        notifyError(new Error('Clio gateway is not connected'), 'Could not send sudo password')
    ...
    <Dialog onOpenChange={onOpenChange} open>
      <DialogContent showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>
            Clio needs your sudo password to run a privileged command. It is sent only to your local agent.
          </DialogDescription>
        </DialogHeader>
...
function SecretDialog() {
  ...
  const send = useCallback(
    async (secret: string) => {
      ...
      if (!gateway) {
        notifyError(new Error('Clio gateway is not connected'), 'Could not send secret')
    ...
    <Dialog onOpenChange={onOpenChange} open>
      <DialogContent showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>{request.prompt || 'Clio needs a credential to continue.'}</DialogDescription>
        </DialogHeader>
