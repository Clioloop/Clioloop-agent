...
export const en: Translations = {
  ...
  boot: {
    ready: 'Clio Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Clio settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingClioDesktop: 'Starting Clio Desktop…'
    },
    errors: {
      backgroundExited: 'Clio background process exited.',
      backgroundExitedDuringStartup: 'Clio background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Clio backend is older than this desktop build and may not work correctly. Update to align them.',
    updateClio: 'Update Clio',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Clio Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Clio defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Clio follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Clio checks for updates automatically in the background and lets you know when one is ready.',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Clio desktop' },
    ...
    clioActiveSessions: (version, count) => `Clio ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Clio environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Clio will run it and deliver results to the destination you pick.',
  ...
  composer: {
    message: 'Message',
    placeholderStarting: 'Starting Clio...',
    placeholderReconnecting: 'Reconnecting to Clio…',
    ...
    attachUrlDesc: 'Clio will fetch the page and include it as context for this turn.',
