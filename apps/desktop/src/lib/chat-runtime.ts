...
import type { ModelOptionsResponse, SessionInfo } from '@/types/clio'
 ...
 *
 * Only the leading status prefix (e.g. "Clio is thinking...") and the
...
export function isMusicGenerationTool(name?: string): boolean {
  return name === 'music_generate'
}
