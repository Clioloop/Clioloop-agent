...
const SIDEBAR_PINNED_STORAGE_KEY = 'clio.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'clio.desktop.agentsGroupedByWorkspace'
const PANES_FLIPPED_STORAGE_KEY = 'clio.desktop.panesFlipped'
