...
const MANAGED_BLUE = '#7C3AED'
const PSYCHE_BLUE = '#4C1D95'
const PSYCHE_WARM = '#EDE9FE'

const clioTint = (pct: number) => `color-mix(in srgb, ${MANAGED_BLUE} ${pct}%, #FFFFFF)`
const clioTintTransparent = (pct: number) => `color-mix(in srgb, ${MANAGED_BLUE} ${pct}%, transparent)`

/**
 * Clio — canonical desktop identity. The palette keeps the current
 * glass geometry neutral, then lets the old bb/gui blue and psyche cream
 * return as accent seeds.
 */
export const managedTheme: DesktopTheme = {
  name: 'managed',
  label: 'Clio',
  description: 'Purple glass with living infinity accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    ...
    primary: MANAGED_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: clioTint(7),
    secondaryForeground: '#242432',
    accent: clioTint(10),
    accentForeground: '#202030',
    border: clioTintTransparent(22),
    input: clioTintTransparent(30),
    ring: MANAGED_BLUE,
    midground: MANAGED_BLUE,
    composerRing: MANAGED_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: clioTintTransparent(18),
    userBubble: clioTint(6),
    userBubbleBorder: clioTintTransparent(24)
  },
  darkColors: {
    background: '#16042D',
    ...
    sidebarBackground: '#110222',
    sidebarBorder: '#4C1D95',
    userBubble: '#2E1554',
    userBubbleBorder: '#6D28D9'
  },
  typography: {
...
export const DEFAULT_SKIN_NAME = 'managed'
