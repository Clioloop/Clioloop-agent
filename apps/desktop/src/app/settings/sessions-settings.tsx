...
// / Program Files), which buried any files Clio wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.clioDesktop` is
    ...
    const settings = window.clioDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || `Defaults to ${fallback || '~/clio-projects'}.`}
