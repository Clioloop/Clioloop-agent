import type { ClioConfigRecord, ToolsetInfo } from '@/types/clio'
...
export function getNested(obj: ClioConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ClioConfigRecord, path: string, value: unknown): ClioConfigRecord {
...
function personalityOptions(config: ClioConfigRecord): string[] {
