...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/clio'
...
import { type AppView, ARTIFACTS_ROUTE, BOTS_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'bots', label: 'Bots', icon: props => <Codicon name="hubot" {...props} />, route: BOTS_ROUTE },
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('clio:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('clio:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  return (
    <Sidebar
      className={cn(
        ...
        sidebarOpen
          ? 'border-(--sidebar-edge-border) bg-[color-mix(in_srgb,var(--ui-sidebar-surface-background)_82%,transparent)] opacity-100 shadow-[0_0_64px_rgba(124,58,237,0.18)] backdrop-blur-xl'
