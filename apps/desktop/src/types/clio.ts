...
export type ClioConfigRecord = Record<string, unknown>
...
export interface ModelAssignmentResponse {
  ...
  base_url?: string
  /** Toolset keys auto-routed through the managed provider Tool Gateway as a result of
   *  switching the main provider to managed provider. Empty unless provider === 'managed'
