...
DEFAULT_DATASETS = [
    "Clioloop/swe-terminus-agent-glm-kimi-minimax",
    "Clioloop/Clioloop-agent-megascience-sft1",
    "Clioloop/Clioloop-agent-Thinking-GLM-4.7-SFT2",
    "Clioloop/Clioloop-agent-Thinking-GLM-4.7-SFT1",
    "Clioloop/terminal-tasks-glm-clio-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Clioloop/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Clioloop/{output_name} {final_output}")
