#!/usr/bin/env python3
"""Build the Clio Skills Index — a centralized JSON catalog of all skills.
...
`clio skills search/install` can use it without hitting the GitHub API.
...
# Ensure CLIO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Clio Skills Index...", flush=True)
