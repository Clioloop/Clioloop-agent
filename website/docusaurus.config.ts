...
const config: Config = {
  ...
  url: 'https://clio-agent.',
  baseUrl: '/docs/',

  organizationName: 'Clioloop',
  projectName: 'clio-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Clioloop/Clioloop-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/clio-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://clio-agent.',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/Clioloop/Clioloop-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/Clioloop',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/Clioloop' },
            { label: 'GitHub Issues', href: 'https://github.com/Clioloop/Clioloop-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://clio-agent./desktop' },
            { label: 'GitHub', href: 'https://github.com/Clioloop/Clioloop-agent' },
            { label: 'Omni Loop Labs', href: 'https://' },
          ],
        },
      ],
      copyright: `Built by <a href="https://">Omni Loop Labs</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
