...
```bash
python3 -m pyfiglet "CLIO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CLIO&font=Slant" | boxes -d stone
```
