...
| | |
|---|---|
| Source | Optional — install with `clio skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Clio Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CLIO_OSINT_CACHE/icij/ (default: ~/.cache/clio-osint/icij/).
...
# Set CLIO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
