...
| | |
|---|---|
| Source | Optional — install with `clio skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/Omni Loop Labs/.clio/skills/creative/pixel-art/scripts")
...
```bash
cd /home/Omni Loop Labs/.clio/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Clio installs package this)
