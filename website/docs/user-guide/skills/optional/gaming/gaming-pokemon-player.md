...
| | |
|---|---|
| Source | Optional — install with `clio skills install official/gaming/pokemon-player` |
...
The repo is Clioloop/pokemon-agent on GitHub. Clone it, then
...
On this machine it is already set up at /home/Omni Loop Labs/pokemon-agent
