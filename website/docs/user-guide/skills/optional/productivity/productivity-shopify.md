...
| | |
|---|---|
| Source | Optional — install with `clio skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Clio","productType":"Apparel","tags":["test"]}}'
```
