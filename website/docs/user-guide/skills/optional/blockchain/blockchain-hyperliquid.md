...
| | |
|---|---|
| Source | Optional — install with `clio skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Clio Agent |
| License | MIT |
...
The script reads `~/.clio/.env` for two optional defaults:
...
Helper script: `~/.clio/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.clio/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.clio/.env`.
...
```bash
python3 ~/.clio/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.clio/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
