...
| | |
|---|---|
| Source | Optional — install with `clio skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Clio Agent |
| License | MIT |
...
```
SCRIPT=~/.clio/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.clio/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
