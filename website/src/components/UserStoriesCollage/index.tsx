  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Clio Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Clio &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Clio?{' '}
        <a
          href="https://github.com/Clioloop/Clioloop-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Clioloop" target="_blank" rel="noopener noreferrer">
          Omni Loop Labs Discord
        </a>{' '}
