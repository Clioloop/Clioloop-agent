...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      clioNpmLib = self'.packages.default.passthru.clioNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. clio-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Clio Agent dev shell"
          ${combinedNonNpm}
          ${clioNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}
          echo "Ready. Run 'clio' to start."
        '';
      };
    };
}
