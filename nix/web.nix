# nix/web.nix — Clio Web Dashboard (Vite/React) frontend build
{ pkgs, clioNpmLib, ... }:
let
  npm = clioNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "clio-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../clio_cli/web_dist for the
