...
projection into Clio' display, approval bridging, transcript projection into
...
"codex_app_server"`. Clio' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("CLIO_KANBAN_TASK"):
            kanban_db = spawn_env.get("CLIO_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "CLIO_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("CLIO_HOME", os.path.expanduser("~/.clio")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "clio",
        client_title: str = "Clio Agent",
