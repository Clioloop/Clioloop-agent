...
def build_managed_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines = [
        ...
        "managed subscription includes managed web tools (Firecrawl), image generation (FAL), OpenAI TTS, and browser automation (Browser Use) by default. Modal execution is optional.",
    ...
    lines.extend(
        [
            ...
            "If the user is not subscribed and asks for a capability that managed subscription would unlock or simplify, suggest managed subscription as one option alongside direct setup or local alternatives.",
