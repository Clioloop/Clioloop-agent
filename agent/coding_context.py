"""Coding-context awareness — base Clio, every interactive surface.

When the user runs Clio inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Clio shifts into a **coding posture**. This module is the
...
from clio_cli._subprocess_compat import bounded_git_probe

logger = logging.getLogger("clio.coding_context")
...
def is_coding_context(
    *,
    ...
    """Whether Clio should operate in its coding posture right now."""
