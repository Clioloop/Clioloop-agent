...
def summarize_manual_compression(
    ...
    *,
    ...
    """Return consistent, state-aware feedback for manual compression."""
    ...
    if refused_would_grow or aborted or (noop and after_tokens == before_tokens):
    ...
    if refused_would_grow:
        ...
        note = (
            "Summary generation failed; Clio preserved limited fallback "
            f"context and removed {dropped_count} message(s)."
        )
