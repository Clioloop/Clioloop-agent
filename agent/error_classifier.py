...
#
# See: https://github.com/Clioloop/Clioloop-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, managed provider) run before
    ...
    if status_code == 404:
        # managed-provider API currently surfaces HA/NAS credit depletion as a paid model
