      ...
      <div className="container">
        ...
        <section className="hero fade-up">
          <div className="hero-split">
            <div>
              <span className="hero-badge">
                <InfinityMark className="logo-mark" /> agentic fusion · 300+
                models · one login
              </span>
              <h1>
              ...
              <p className="lede">
                ...
                <strong>Agentic Fusion</strong>: a panel of models plans the
                route, your main model does the real work, independent reviewers
                critique it, and it all fuses into one answer you can trust. One
                login unlocks 300+ models and the full tool gateway — no API
                keys.
              </p>
          ...
          <div className="terminal">
            ...
            <div className="terminal-body">
              ...
              <div className="t-dim">
                Opening browser… approve this device with code
              </div>
              <div>
        ...
        <section className="section" id="fusion">
          <div className="section-head">
            ...
            <p>
              Run <code>/fusion</code> and put a whole crew of models on a
              single task. Planners propose routes, your main model does the
              real, full-tool work
              <strong> in the open</strong>, independent reviewers critique the
              draft, and everything fuses into one reviewed-and-approved answer.
              The quality comes from the <strong>synthesis</strong> — not from
              brute-forcing the same job five times — so cheap open models
              combine into something that rivals a frontier model, at a fraction
              of the cost. Start each Fusion run from a fresh session and reset
              after the final answer so the next advisor/reviewer panel gets
              clean context.
            </p>
          </div>
          ...
          <div className="fusion-flagship">
            <div className="fusion-stage">
              <div className="fusion-tier">
                <span className="fusion-tier-label">
                  1 · planners — read-only, in parallel
                </span>
              ...
              <div className="fusion-core">
                ...
                <span className="fusion-core-sub">
                  full-tool work · visible
                </span>
              </div>
              ...
              <div className="fusion-tier">
                <span className="fusion-tier-label">
                  2 · reviewers — read-only, can see images
                </span>
                <div className="fusion-chips">
            ...
            <div className="fusion-points">
              <div className="fusion-point">
                ...
                <p>
                  Planners and reviewers are read-only at the schema level —
                  they can research and critique, but they can never touch your
              ...
              <div className="fusion-point">
                ...
                <p>
                  Your main model does the work live, not in a black box.
                  Reviewers even get
                  <code> vision_analyze</code> so they can see the images it
                  generates.
                </p>
              </div>
              <div className="fusion-point">
                ...
                <p>
                  A verdict loop revises the draft until reviewers approve — so
                  the answer that reaches you has already passed review.
                </p>
              </div>
              <div className="fusion-point">
                <h4>🧩 Any model combo</h4>
                <p>
                  Mix open-weight, OpenRouter and managed models as planners,
                  reviewers and the main worker. Pick them in a quick picker in
                  any client. Pro plan and up.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="section" id="what-is-clioloop">
          <div className="section-head">
            ...
            <p>
              Clioloop is an open-source AI agent that lives in your terminal, a
              desktop app, a web dashboard and your chat apps. Give it a goal
              and it keeps working — planning, running tools, checking its own
              progress — until the job is done. It remembers what it learns
              about you and your work, and gets more capable the more you use
              it.
            </p>
          </div>
          <div className="grid-3">
            <div className="card">
              ...
              <p>
                <code>/goal</code> starts a loop: after every turn a judge
                decides if the goal is met. If not, Clioloop takes the next step
                automatically — across the terminal, gateway chats and the
                desktop app, with a live banner showing progress.
              </p>
            </div>
            <div className="card">
              ...
              <p>
                Break big work into a board of tasks. New tasks land in Triage
                for review, then worker agents pick them up, run them and report
                back — visible in both the web dashboard and the desktop app.
              </p>
            </div>
            <div className="card">
              <div className="card-icon">🧠</div>
              ...
              <p>
                Clioloop keeps a persistent <code>MEMORY.md</code> and{" "}
                <code>USER.md</code>, updated automatically as it learns your
                preferences and projects — so the next session already knows
                you.
              </p>
            </div>
            <div className="card">
              ...
              <p>
                <code>/fusion</code> puts a whole team of models on one task: up
                to five planners propose routes, your main model does the
                full-tool work in the open, up to five reviewers critique the
                draft, and it all fuses into one approved answer. Frontier
                intelligence on open models — Pro plan and up.
              </p>
            </div>
            <div className="card">
              <div className="card-icon">💬</div>
              ...
              <p>
                A messaging gateway lets you run the agent from Telegram, Slack,
                WhatsApp, Discord and more — the same session, the same memory,
                on your phone.
              </p>
            </div>
            <div className="card">
              ...
              <h3>Tools &amp; MCP</h3>
              <p>
                File editing, shell, web search &amp; extract, a cloud browser,
                image and video generation, text-to-speech — plus any MCP server
                you connect. Scheduled jobs run it on a <code>cron</code>.
              </p>
            </div>
          </div>
          <div className="hero-actions" style={{ marginTop: 28 }}>
        ...
        <section className="section" id="download">
          <div className="section-head">
            ...
            <p>
              Clioloop runs on Linux, macOS and Windows. It&apos;s fully open
              source — read every line on{" "}
          ...
          <div className="grid-3">
            ...
            <div className="card">
              ...
              >
                <strong>Heads up:</strong> the installer isn&apos;t code-signed
                yet, so Windows SmartScreen may show a &quot;Windows protected
                your PC&quot; warning. That&apos;s expected — nothing harmful is
                in the app. Click <strong>More info → Run anyway</strong>.
                Everything is open source and auditable on{" "}
                <a href="https://github.com/Clioloop/Clioloop-agent">GitHub</a>{" "}
                if you&apos;d like to check first.
              </p>
            </div>
            <div className="card">
              <div className="card-icon">∞</div>
              ...
              <p>
                ...
                <strong>Omni Loop Portal</strong> for one login and 300+ models
        ...
        <section className="section" id="features">
          <div className="section-head">
            ...
            <p>
              Clioloop doesn&apos;t stop until the goal is reached — your model
              and tool access shouldn&apos;t either.
            </p>
          </div>
          <div className="grid-3">
            <div className="card">
              ...
              <p>
                No keys to copy, ever. The CLI, TUI, desktop app and dashboard
                all connect with a browser approval — a device-code flow
                straight out of RFC 8628.
              </p>
            </div>
            <div className="card">
              <div className="card-icon">🧠</div>
              ...
              <p>
                Claude, GPT, Gemini, Grok, DeepSeek, Qwen, Kimi and every
                notable open model — switch mid-session with <code>/model</code>
                .
              </p>
            </div>
            <div className="card">
              ...
              <p>
                Web search &amp; extract, image and video generation,
                text-to-speech and cloud browser sessions — all billed against
                your subscription instead of four separate vendor accounts.
              </p>
            </div>
            <div className="card">
              <div className="card-icon">⚡</div>
              ...
              <p>
                Full OpenAI-compatible inference with SSE streaming, tool calls
                and vision — everything the agent loop needs at full speed.
              </p>
            </div>
            <div className="card">
              <div className="card-icon">🔄</div>
              ...
              <p>
                Single-use refresh tokens with reuse detection. Lose a laptop?
                The whole device family is revoked the moment the old token is
                replayed.
              </p>
            </div>
            <div className="card">
        ...
        <section className="section">
          <div className="section-head">
            ...
            <p>
              The quick setup is the default path in every Clioloop surface.
            </p>
          </div>
          <div className="steps">
            <div className="step">
              <h3>Run the setup</h3>
              <p>
                Install Clioloop and run the wizard. &quot;Omni Loop
                Portal&quot; is the first option.
              </p>
            ...
            <div className="step">
              ...
              <p>
                Your browser opens this portal with a device code. Log in, check
            ...
            <div className="step">
              ...
              <p>
                Choose from the live catalog and start. Tokens refresh
                automatically — you never touch a key.
              </p>
              <code>clio</code>
            </div>
          </div>
        ...
        <section className="section" id="commands">
          <div className="section-head">
            ...
            <p>
              ...
              subcommand for everything else — or use slash commands
              mid-conversation.
            </p>
          </div>
          <div className="grid-3">
            <div className="card">
              ...
              <ul className="cmd-list">
                <li>
                  <code>clio setup</code> — first-run wizard
                </li>
                <li>
                  <code>clio auth</code> — log in / add providers
                </li>
                <li>
                  <code>clio model</code> — pick model &amp; provider
                </li>
                <li>
                  <code>clio status</code> — keys, model, health
                </li>
                <li>
                  <code>clio doctor</code> — diagnose problems
                </li>
                <li>
                  <code>clio update</code> — upgrade Clioloop
                </li>
              </ul>
            </div>
            <div className="card">
              ...
              <ul className="cmd-list">
                <li>
                  <code>clio</code> — interactive chat
                </li>
                <li>
                  <code>clio --tui</code> — full terminal UI
                </li>
                <li>
                  <code>clio desktop</code> — desktop app
                </li>
                <li>
                  <code>clio dashboard</code> — web dashboard
                </li>
                <li>
                  <code>clio gateway</code> — Telegram/Slack/WhatsApp…
                </li>
                <li>
                  <code>clio send</code> — message a channel from scripts
                </li>
              </ul>
            </div>
            <div className="card">
              ...
              <ul className="cmd-list">
                <li>
                  <code>clio kanban</code> — multi-agent task board
                </li>
                <li>
                  <code>clio cron</code> — scheduled jobs
                </li>
                <li>
                  <code>clio skills</code> — manage skill packs
                </li>
                <li>
                  <code>clio mcp</code> — connect MCP servers
                </li>
                <li>
                  <code>clio memory</code> — view/edit memory
                </li>
                <li>
                  <code>clio sessions</code> · <code>clio profile</code>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="code-block">
            ...
            <span className="c-comment">
              # keep working until a goal is judged done
            </span>
            <br />
            <span className="c-cmd">/subgoal</span>{" "}
            <span className="c-comment">
              # add acceptance criteria to the active goal
            </span>
            <br />
            <span className="c-cmd">/model</span>{" "}
            <span className="c-comment">
              # switch model or provider without restarting
            </span>
            <br />
            ...
            <span className="c-comment">
              # load expertise for the task at hand
            </span>
            <br />
            <span className="c-cmd">/fusion</span>{" "}
            <span className="c-comment">
              # planners + reviewers + your model → one fused answer (Pro)
            </span>
            <br />
            <span className="c-cmd">/help</span>{" "}
            <span className="c-comment">
              # list every command in your build
            </span>
          </div>
        </section>
        ...
        <section className="section">
          <div className="cta-banner">
            ...
            <h2 style={{ marginTop: 18 }}>
              Give your agent the whole universe
            </h2>
            <p>
              Start free with one model, or go Pro for the full 300+ catalog,
              the Tool Gateway and Agentic Fusion. Cancel anytime.
            </p>
            <div className="hero-actions">
