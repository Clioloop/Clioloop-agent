...
class TestGetDefaultModelForProvider:
    """Unit tests for clio_cli.models.get_default_model_for_provider."""
    ...
    def test_managed_silent_default_is_not_the_expensive_flagship(self):
        """managed provider is a metered aggregator whose curated list is ordered
        ...
        result = get_default_model_for_provider("managed")
        assert result, "managed must resolve to a usable default model"
