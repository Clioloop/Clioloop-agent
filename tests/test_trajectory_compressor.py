...
def test_import_loads_env_from_clio_home(tmp_path, monkeypatch):
    home = tmp_path / ".clio"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-clio-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-clio-home"
