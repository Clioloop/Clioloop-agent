...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("clio_cli.config.get_config_path", return_value=config_path), \
             patch("clio_cli.config.ensure_clio_home"):
    ...
    def test_ensure_clio_home_sets_0700(self):
        home = Path(self.tmpdir) / ".clio"
        with patch("clio_cli.config.get_clio_home", return_value=home):
