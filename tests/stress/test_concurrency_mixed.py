...
def worker_loop(worker_id: int, clio_home: str, result_file: str) -> None:
...
def reclaimer_loop(clio_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="clio_mixed_stress_")
    print(f"CLIO_HOME = {home}")
