...
The unit tests in tests/clio_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned clio-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/clio")
from clio_cli.service_manager import S6ServiceManager
