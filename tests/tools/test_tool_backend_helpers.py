...
class TestManagedToolsEnabled:
    ...
    @pytest.mark.skip(reason="Managed managed provider Tool Gateway removed in Clio rebrand (phase 12)")
...
class TestManagedToolGatewayUnavailableMessage:
    ...
    def test_uses_entitlement_reason_for_logged_in_user(self, monkeypatch):
        ...
        message = managed_tool_gateway_unavailable_message("managed image generation")
