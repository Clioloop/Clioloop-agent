...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.clio/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at clio_state import time, before pytest's CLIO_HOME monkeypatch
    fires — the autouse fixture's CLIO_HOME override doesn't help here.)
    """
    import clio_state
