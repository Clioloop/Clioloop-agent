...
def isolated_home(monkeypatch):
    """Temp CLIO_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="clio_test_31179_")
    clio_home = os.path.join(test_home, ".clio")
    os.makedirs(clio_home)
