...
5. Recovery is skipped for aggregator providers (OpenRouter, managed provider)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_managed_provider(self):
        agent = _make_agent(provider="managed", base_url="https://inference.managed./v1")
        error = _make_transport_error("ReadTimeout")
