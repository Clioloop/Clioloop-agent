"""Tests for the specifier module + `clio kanban specify` CLI surface.
...
from clio_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `clio kanban …` argparse surface directly."""
