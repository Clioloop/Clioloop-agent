...
class TestProviderRegistry:
    ...
    def test_oauth_providers_unchanged(self):
        ...
        The managed provider returned as the Omni Loop Portal (device-code
        OAuth) alongside the xai-oauth + openai-codex external OAuth flows.
        """
        assert "managed" in PROVIDER_REGISTRY
        assert PROVIDER_REGISTRY["managed"].auth_type == "oauth_device_code"
        assert PROVIDER_REGISTRY["managed"].name == "Omni Loop Portal"
