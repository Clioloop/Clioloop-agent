...
class TestProviderRegistry:
    ...
    def test_oauth_providers_unchanged(self):
        ...
        managed oauth provider was removed in the Clio rebrand (phase 4); the
        registry now only carries xai-oauth + openai-codex.
        """
        assert "managed" not in PROVIDER_REGISTRY
