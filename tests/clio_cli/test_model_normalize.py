"""Tests for clio_cli.model_normalize — provider-aware model name normalization.
...
class TestAggregatorProviders:
    ...
    def test_managed_preserves_selected_id(self):
        result = normalize_model_for_provider("gpt-5.4", "managed")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (managed provider portal, OpenRouter via DeepInfra) routes to V3 —
