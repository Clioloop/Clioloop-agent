...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from clio_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CLIO_OVERLAYS
        overlay = CLIO_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify clio doctor recognizes Xiaomi env vars."""
