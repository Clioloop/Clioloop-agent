...
The main() function in clio_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `clio -c model`
...
def _build_parser():
    """Build a minimal replica of the clio top-level parser."""
