...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from clio_cli.models import normalize_provider
    ...
    def test_normalize_provider_providers_py(self):
        from clio_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
# =============================================================================
# CANONICAL_PROVIDERS (clio model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / managed provider curated lists
# =============================================================================


class TestTencentInOpenRouterAndManaged:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and managed provider curated lists."""

    def test_in_openrouter_fallback(self):
        from clio_cli.models import OPENROUTER_MODELS
    ...
    def test_in_managed_provider_models(self):
        from clio_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["managed"]
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from clio_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from clio_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in CLIO_OVERLAYS
        overlay = CLIO_OVERLAYS["tencent-tokenhub"]
    ...
    def test_get_provider(self):
        pdef = None
        try:
            from clio_cli.providers import get_provider
...
class TestTencentTokenhubDoctor:
    """Verify clio doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from clio_cli.providers import CLIO_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = CLIO_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``clio model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from clio_cli import main as main_mod
...
class TestTencentTokenhubApiMode:
    ...
    def test_determine_api_mode_direct(self):
        from clio_cli.providers import determine_api_mode
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from clio_cli.models import _KNOWN_PROVIDER_NAMES
