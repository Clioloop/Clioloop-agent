"""Tests for `clio curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import clio_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated CLIO_HOME with real agent-created skills on disk."""
    home = tmp_path / ".clio"
    skills = home / "skills"
    ...
    from clio_cli import curator as curator_cli
