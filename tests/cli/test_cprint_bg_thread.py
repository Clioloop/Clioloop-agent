...
``💾 Clioloop completed: …`` summary actually surfaces to the user.
...
def test_cprint_bg_thread_schedules_on_app_loop(monkeypatch):
    ...
    cli._cprint("💾 Clioloop completed: Skill updated")
    ...
    assert direct_prints == ["💾 Clioloop completed: Skill updated"]
