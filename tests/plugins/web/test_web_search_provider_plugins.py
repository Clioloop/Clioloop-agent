...
class TestErrorResponseShapes:
    ...
    def test_firecrawl_config_error_points_paid_users_to_managed_subscription(self, monkeypatch):
        ...
        assert "With your managed subscription you can also use the Tool Gateway" in message
        assert "select managed provider Subscription as the web provider" in message
