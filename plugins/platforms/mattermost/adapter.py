...
required — uses aiohttp which is already a Clio dependency.
...
def interactive_setup() -> None:
    ...
    ``clio_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Clio delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # clio_cli/setup.py::_setup_mattermost function.
