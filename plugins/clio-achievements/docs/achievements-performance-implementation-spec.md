# Clio Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.clio/plugins/clio-achievements/state.json` (existing unlock state)
  - `~/.clio/plugins/clio-achievements/scan_snapshot.json` (new)
  - `~/.clio/plugins/clio-achievements/scan_checkpoint.json` (new)
