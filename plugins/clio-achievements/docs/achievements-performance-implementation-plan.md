# Clio Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.clio/plugins/clio-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.clio/plugins/clio-achievements/scan_checkpoint.json`.
