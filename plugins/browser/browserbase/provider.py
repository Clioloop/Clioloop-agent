...
credentials. Managed managed-provider gateway support has been removed — the managed provider
...
class BrowserbaseBrowserProvider(BrowserProvider):
    ...
    Direct credentials only — managed-provider-gateway support lives on the
