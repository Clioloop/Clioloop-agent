...
``_check_spotify_available()`` — when the user has not run ``clio auth
spotify``, the tools remain registered (so they appear in ``clio
...
The Spotify auth flow (``clio auth spotify``), CLI plumbing, and docs
