...
Config: ~/.clio/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.clio/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_clio_home()`` helper (CLIO_HOME-aware and
...
RULES_FILE = get_clio_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_clio_home() / "feishu_comment_pairing.json"
