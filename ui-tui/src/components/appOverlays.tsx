...
import { FusionPicker } from './fusionPicker.js'
    ...
    <Box alignItems="flex-start" bottom="100%" flexDirection="column" left={0} position="absolute" right={0}>
      ...
      {overlay.fusionPicker && (
        <FloatBox color={theme.color.border}>
          <FusionPicker
            gw={gw}
            onCancel={() => patchOverlayState({ fusionPicker: false })}
            onNotice={onFusionNotice}
            sessionId={sid}
            t={theme}
          />
        </FloatBox>
