...
import type { ScrollBoxHandle } from '@clio/ink'
import { evictInkCaches } from '@clio/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CLIO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
