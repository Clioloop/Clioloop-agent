"""
Skills configuration for Clio Agent.
`clio skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.clio/config.yaml under:
...
from clio_cli.config import cfg_get, load_config, save_config
from clio_cli.colors import Colors, color
from clio_cli.platforms import PLATFORMS as _PLATFORMS
