...
.. code-block:: yaml
    ...
    colors:
      banner_border: "#5B21B6"            # Panel border color
      banner_title: "#A78BFA"             # Panel title text color
      banner_accent: "#7C3AED"            # Section headers (Available Tools, etc.)
      banner_dim: "#C4B5FD"               # Dim/muted text (separators, labels)
      banner_text: "#EDE9FE"              # Body text (tool names, skill names)
      ui_accent: "#7C3AED"               # General UI accent
      ui_label: "#C4B5FD"                # UI labels (violet; teal clashed w/ default banner gold)
      ui_ok: "#4caf50"                   # Success indicators
      ui_error: "#ef5350"                # Error indicators
      ui_warn: "#ffa726"                 # Warning indicators
      prompt: "#EDE9FE"                  # Prompt text color
      input_rule: "#5B21B6"              # Input area horizontal rule
      response_border: "#A78BFA"         # Response box border (ANSI)
      status_bar_bg: "#1a1a2e"           # Status bar background
      status_bar_text: "#C0C0C0"         # Status bar default text
      status_bar_strong: "#A78BFA"       # Status bar highlighted text
      status_bar_dim: "#8B8682"          # Status bar separators/muted text
      status_bar_good: "#8FBC8F"         # Healthy context usage
      status_bar_warn: "#7C3AED"         # Warning context usage
      status_bar_bad: "#FF8C00"          # High context usage
      status_bar_critical: "#FF6B6B"     # Critical context usage
      session_label: "#C4B5FD"           # Session label color
...
.. code-block:: python
    ...
    from clio_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
- ``default`` — Classic Clio gold/clio-spinner (the current look)
...
Drop a YAML file in ``~/.clio/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CLIO_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CLIO_INFINITY)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Clio — violet and infinity",
        "colors": {
            "banner_border": "#5B21B6",
            "banner_title": "#A78BFA",
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    input_rule = skin.get_color("input_rule", "#5B21B6")
    title = skin.get_color("banner_title", "#A78BFA")
    text = skin.get_color("banner_text", "#EDE9FE")
