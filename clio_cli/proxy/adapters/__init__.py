...
from clio_cli.proxy.adapters.base import UpstreamAdapter
from clio_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``clio proxy start --provider <name>`` CLI flag.
