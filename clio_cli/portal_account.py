"""Omni Loop Portal Subscription account info.
...
class ManagedProviderAccountInfo:
    """Account descriptor for the Omni Loop Portal Subscription provider."""
...
class ManagedProviderAccessInfo:
    """Paid-service descriptor for the Omni Loop Portal Subscription provider."""
...
def get_managed_provider_account_info(force_fresh: bool = False) -> ManagedProviderAccountInfo:
    """Return the Omni Loop Portal Subscription account info for the current login.
...
def format_managed_provider_entitlement_message(
    ...
    *,
    ...
    return (
        f"Your Omni Loop Portal Subscription account is on the Free plan — {what} require "
