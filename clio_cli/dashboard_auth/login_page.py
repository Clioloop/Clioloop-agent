...
Visual styling mirrors the Omni Loop Labs design system (the
``@clioloop-agent/ui`` package the React dashboard uses): the same
...
``tests/clio_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<p>Install <code>plugins/dashboard-auth-managed_provider</code> (default) or another
