...
def _has_any_provider_configured() -> bool:
    ...
    # Check for managed provider OAuth credentials (legacy — Portal removed in Clio rebrand)
...
def _model_flow_managed(config, current_model="", args=None):
    """Stub: managed provider provider removed in Clio rebrand.

    Kept as a no-op shim so callers in setup.py / model_switch.py that
    import this symbol continue to compile. Replaced by direct provider
    selection in the setup wizard.
    """
    return None
...
def _print_curator_first_run_notice() -> None:
    ...
    print(
        "  Docs:         https://clio-agent./docs/user-guide/features/curator"
    )
...
def main():
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://clio-agent./docs/user-guide/features/fallback-providers"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://clio-agent./docs/user-guide/secrets/bitwarden"
        ),
    )
