...
def _is_retired_managed_gateway_provider(provider: dict) -> bool:
    ...
    return bool(provider.get("managed_feature")) or name in RETIRED_MANAGED_GATEWAY_NAMES
...
TOOL_CATEGORIES = {
    ...
    "video_gen": {
        ...
        # ``_visible_providers``. The managed provider managed-subscription
        # row was removed in the Clio rebrand (phase 12).
        "providers": [],
    },
    "x_search": {
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    ...
    print(color("  Guide: https://clio-agent./docs/user-guide/features/tools", Colors.DIM))
    print()
