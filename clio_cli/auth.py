...
# Clio agent: managed provider provider removed in rebrand. Constants retained
# as no-op aliases for any code paths that still import them.
DEFAULT_MANAGED_PORTAL_URL = ""
DEFAULT_MANAGED_INFERENCE_URL = ""
...
SPOTIFY_DOCS_URL = "https://clio-agent./docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

XAI_OAUTH_DOCS_URL = "https://clio-agent./docs/guides/xai-grok-oauth"
OAUTH_OVER_SSH_DOCS_URL = "https://clio-agent./docs/guides/oauth-over-ssh"
...
def _format_managed_entitlement_auth_error(error: AuthError) -> str:
    try:
        ...
        message = format_managed_provider_entitlement_message(
            account_info,
            capability="managed provider model access",
        )
        if message:
            return message
    except Exception:
