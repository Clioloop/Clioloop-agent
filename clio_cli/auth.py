...
# Omni Loop Portal — Clioloop's managed model provider. One device login gives
    ...
    try:
        ...
        if getattr(args, "reuse_existing", False):
            ...
            if existing and existing.get("access_token") and existing.get("inference_base_url"):
                ...
                print("Could not reuse the existing Omni Loop Portal login — starting a fresh one.")
