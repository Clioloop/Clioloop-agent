...
Used by ``clio profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Clio Agent kanban board.
...
Rules:
  ...
  - Never write "Clio Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_clio_home())
        else:
