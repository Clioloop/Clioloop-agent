...
async def portal_connect_start():
    ...
    try:
        ...
        try:
            ...
            portal_url = "the Omni Loop Portal"
        return JSONResponse(
...
_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.clio-agent."
    ...
    try:
        ...
        if provider_id == "managed":
            ...
            return {
                ...
                "source_label": raw.get("portal_base_url") or "Omni Loop Portal",
