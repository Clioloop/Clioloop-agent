...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "email": {
        ...
        "docs_url": "https://clio-agent./docs/user-guide/messaging/",
        "env_vars": (
            "EMAIL_ADDRESS",
            "EMAIL_PASSWORD",
            "EMAIL_IMAP_HOST",
    ...
    "webhook": {
        ...
        "docs_url": "https://clio-agent./docs/user-guide/messaging/webhooks/",
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "docs_url": "https://clio-agent./docs/guides/xai-grok-oauth",
    ...
    try:
        ...
        if provider_id == "managed":
            ...
            return {
                ...
                "source_label": raw.get("portal_base_url") or "managed provider",
