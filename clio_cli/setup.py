...
_DOCS_BASE = "https://clio-agent./docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://clio-agent./docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://clio-agent./docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://clio-agent./docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def _run_portal_one_shot(config: dict) -> None:
    """One-shot provider setup — pick a provider, model, and tools.

    Wired into ``clio setup --portal``. Delegates to the shared provider
    picker so the first prompt is the provider list, not any specific
    provider.
    """
    ...
    print()
    print_info("  Pick a provider, choose a model, and you're ready to go.")
    print()
...
def run_setup_wizard(args):
    ...
    if is_existing:
        ...
        setup_mode = prompt_choice(
            ...
            [
                "Quick Setup — pick a provider, model, terminal & messaging (recommended)",
