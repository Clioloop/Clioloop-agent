 ...
 * `window.__CLIO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Clio brand in the top bar
 ...
 *  `window.__CLIO_PLUGINS__.registerSlot(...)`.
 *
