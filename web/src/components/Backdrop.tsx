import { useGpuTier } from "@clioloop-agent/ui/hooks/use-gpu-tier";

import fillerBgUrl from "@clioloop-agent/ui/assets/filler-bg0.webp";

/**
 * Replicates the visual layer stack of `<Overlays dark />` from
 * `@clioloop-agent/ui` without pulling in its leva / gsap / three peer deps.
 *
 * See `design-language/src/ui/components/overlays/index.tsx` for the source of
 * truth. Defaults match LENS_0 (the Clio teal dark preset); the deep canvas
 ...
 *         Both LENS_0-style dark themes and the LENS_5I-style managed provider Blue
  ...
  return (
    <>
      <video
        ...
        preload="metadata"
      >
        <source src={assetPath("brand/backgroundvideoloop.webm")} type="video/webm" />
      ...
      <div
        ...
        style={
          {
            background:
              "linear-gradient(135deg, color-mix(in srgb, var(--background-base) 86%, transparent), rgba(16, 4, 33, 0.68) 44%, rgba(8, 18, 34, 0.82))",
            mixBlendMode:
        ...
        style={
          {
            ...
            mixBlendMode:
              "var(--component-backdrop-filler-blend-mode, screen)",
            opacity: "var(--component-backdrop-filler-opacity, 0.08)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 10% 4%, rgba(196, 181, 253, 0.24), transparent 42%), radial-gradient(ellipse at 82% 94%, rgba(45, 212, 191, 0.16), transparent 48%), radial-gradient(ellipse at 0% 100%, var(--warm-glow), transparent 55%)",
          mixBlendMode: "screen",
          opacity: 0.58,
        }}
      />
