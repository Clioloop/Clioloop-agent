...
/**
 * Omni Loop Portal Subscription page — connect this Clioloop install to the managed
          ...
          <CardContent className="p-6">
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  What your Omni Loop Portal Subscription plan includes right now. Set one as
