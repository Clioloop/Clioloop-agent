...
import { SelectionSwitcher } from "@clioloop-agent/ui/ui/components/selection-switcher";
...
const BUILTIN_NAV_REST: NavItem[] = [
  ...
  { path: "/portal", label: "Omni Portal", icon: Sparkles },
...
const SIDEBAR_COLLAPSED_KEY = "clio-sidebar-collapsed";
...
export default function App() {
  ...
  return (
    <div
      ...
      className="flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden bg-transparent text-text-primary antialiased"
    >
      <SelectionSwitcher />
      <Backdrop />
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden pt-14 lg:pt-0">
        <div className="flex min-h-0 min-w-0 flex-1">
          <aside
            ...
            className={cn(
              "fixed top-0 right-0 z-50 flex h-dvh max-h-dvh w-72 min-h-0 flex-col",
              "border-l border-current/20 shadow-[0_0_70px_rgba(124,58,237,0.26)]",
              "bg-background-base/70 backdrop-blur-xl",
              "transition-[transform] duration-200 ease-out",
              mobileOpen ? "translate-x-0" : "translate-x-full",
              "lg:sticky lg:top-0 lg:order-last lg:translate-x-0 lg:shrink-0 lg:overflow-hidden",
          ...
          >
            <div
              className={cn(
                ...
                "border-b border-current/20",
                collapsed ? "lg:justify-center lg:px-0" : "px-4 justify-between bg-white/[0.03]",
              )}
            >
              <div
                className={cn(
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="clio-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="clio-sidebar-plugin-nav-heading"
                  >
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            "mx-1 rounded-md px-4 py-2.5",
            "font-mondwest text-display uppercase text-sm tracking-[0.12em]",
            "whitespace-nowrap transition-[background-color,color,box-shadow] cursor-pointer",
            "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-midground",
            isActive
              ? "bg-midground/15 text-midground shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--midground-base)_34%,transparent)]"
        ...
        {({ isActive }) => (
          <>
            ...
            {isActive && (
              <span
                aria-hidden
                className="absolute right-1.5 top-1/2 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-midground"
                style={{ mixBlendMode: "plus-lighter" }}
              />
            )}
          </>
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateClio,
      runningLabel: t.status.updatingClio,
      spin: false,
    },
  ];
