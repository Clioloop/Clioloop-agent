...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // Point directly to packages/clioloop-ui/dist to avoid
      // broken symlinks from npm file: protocol on fresh installs.
      "@clioloop-agent/ui": path.resolve(
        __dirname,
        "../packages/clioloop-ui/dist",
      ),
    },
    // When clio-ui is symlinked via `file:../../design-language`,
