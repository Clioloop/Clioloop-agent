...
Trust levels:
  - builtin:   Ships with Clio. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.clio/\.env|\~/\.clio/\.env',
     "clio_env_access", "critical", "exfiltration",
     "directly references Clio secrets file"),
    ...
    (r'\.clio/config\.yaml|\.clio/SOUL\.md',
     "clio_config_mod", "critical", "persistence",
     "references Clio configuration files directly"),
...
# scan. `.skillignore` is the Clio-native name; `.clawhubignore` is honored
