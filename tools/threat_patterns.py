...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|AGENT|OPENAI|ANTHROPIC|CLIO)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.clio/\.env|\~/\.clio/\.env', "clio_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.clio/(config\.yaml|SOUL\.md)', "clio_config_mod", "strict"),
