...
the get_anchored_view / get_messages_around primitives in clio_state.
...
# Third-party integrations tag their sessions with CLIO_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from clio_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Clio profile's database "
