        ...
        "properties": {
            ...
            "model": {
                ...
                "description": (
                    ...
                    "Always defaults to suno-v5_5. Do NOT ask the user "
                    "which model to use — this is always V5.5."
                ),
            },
            "style": {
                "type": "string",
            ...
            "confirmed": {
                ...
                "description": (
                    ...
                    "MUST follow the confirmation protocol below DIRECTLY "
                    "IN YOUR RESPONSE TEXT — NOT through the clarify "
                    "tool.\n\n"
                    "DESCRIPTION MODE (auto lyrics): Ask the user for "
                    "these details: (1) instrumental or vocals, (2) style/"
                    "genre tags, (3) vocal gender (if vocals), (4) title. "
                    "Present as a list, wait for answers, THEN call with "
                    "confirmed=true. If the user ALREADY specified ALL of "
                    "these in their initial request, you may set "
                    "confirmed=true immediately.\n\n"
                    "CUSTOM LYRICS MODE (user provides lyrics): You MUST "
                    "show the user a readable PREVIEW of EVERYTHING that "
                    "will be sent to the generator — the full lyrics text, "
                    "the style/genre tags, the title, the vocal gender, "
                    "and whether it's instrumental. Present this as a "
                    "clearly formatted block in your response. Then ask: "
                    "'Shall I generate this?' The user must explicitly say "
                    "yes (or equivalent) before you call with "
                    "confirmed=true. You CANNOT skip this preview step "
                    "even if the user provided all the lyrics and details "
                    "in their initial request — you must still show the "
                    "preview and get explicit confirmation.\n\n"
                    "DO NOT USE THE clarify TOOL. Ask in your normal chat "
                    "response. Ignored for follow-up actions (extend, "
                    "cover, add_vocals, stems)."
                ),
                "default": False,
            },
        },
    ...
    if action == "generate":
        ...
        if not confirmed:
            return tool_error(
                ...
                "You MUST confirm with the user DIRECTLY IN YOUR RESPONSE "
                "TEXT (NOT through the clarify tool) before calling this "
                "tool with confirmed=true.\n\n"
                "DESCRIPTION MODE (auto lyrics): Ask the user for: "
                "instrumental/vocals, style tags, vocal gender, title. "
                "If they already specified ALL of these, you may set "
                "confirmed=true immediately.\n\n"
                "CUSTOM LYRICS MODE: You MUST show a readable PREVIEW of "
                "everything that will be sent to the generator — the full "
                "lyrics, style tags, title, vocal gender, instrumental "
                "flag — then ask 'Shall I generate this?' and wait for "
                "explicit yes. You CANNOT skip this preview even if the "
                "user provided all details upfront.\n\n"
                "Ask in your normal chat response, wait for confirmation, "
...
_GENERIC_DESCRIPTION = (
    ...
    "━━━ DESCRIPTION MODE (auto lyrics) ━━━\n"
    "Ask the user for these details:\n"
    "  1. Instrumental or with vocals?\n"
    "  2. Style/genre tags (e.g. 'synthwave, upbeat, 80s')?\n"
    "  3. Vocal gender (if vocals): male, female, or mixed?\n"
    "  4. Title for the track?\n\n"
    "Present as a list, wait for the user's answers, THEN call with "
    "confirmed=true.\n"
    "EXCEPTION: If the user has ALREADY specified ALL of the above "
    "details in their initial request, you may set confirmed=true "
    "immediately without asking again.\n\n"
    "━━━ CUSTOM LYRICS MODE (user provides lyrics) ━━━\n"
    "You MUST show the user a readable PREVIEW of EVERYTHING that will "
    "be sent to the music generator BEFORE calling the tool. Format this "
    "as a clear block in your response:\n\n"
    "  ┌─ GENERATION PREVIEW ─────────────────────┐\n"
    "  │ Title:           <the title>              │\n"
    "  │ Style:           <style tags>             │\n"
    "  │ Vocals:          <male/female/mixed/none> │\n"
    "  │ Instrumental:    <yes/no>                 │\n"
    "  │ Lyrics:                                    │\n"
    "  │   <full lyrics text, properly formatted>  │\n"
    "  └────────────────────────────────────────────┘\n\n"
    "Then ask: 'Shall I generate this?' The user must explicitly say "
    "yes (or equivalent like 'go ahead', 'generate it', etc.) before "
    "you call with confirmed=true.\n"
    "⚠️ You CANNOT skip this preview step — even if the user provided "
    "all the lyrics and details in their initial request, you MUST "
    "still show the preview and get explicit confirmation.\n\n"
    ...
    "  • DO NOT set confirmed=true until the user has agreed.\n\n"
